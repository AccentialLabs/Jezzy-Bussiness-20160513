    ...
    <div class="form-group notification-body" id="notification-body">
        ...
        <div class="col-md-8">
            ...
            <div>
                ...
                <span class="glyphicon glyphicon-home pull-left"></span><div class="description-info-user">De <?php echo $user['User']['city'];?> - <?php echo $user['User']['state'];?>, <?php echo $user['User']['address'];?>, <?php echo $user['User']['number'];?> - <?php echo $user['User']['zip_code'];?></div>
                                                        <?php }?>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="hoverzoom"><img src="<?php echo $photo['services_photos']['photo'];?>" height="100%" width="100%" onclick="showPhotoInZoom('<?php echo $photo['services_photos']['photo'];?>')"/></div>
                                        <?php }}?>
                                    </td>
                                </tr>
								<?php }?>
