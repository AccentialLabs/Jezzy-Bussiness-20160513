...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
        ...
        $emailBody = ' <table border="0" cellpadding="0" cellspacing="0"  >
            <tr>
                <td colspan="4"><img src="files/reset-senha/01.jpg"  style="vertical-align: bottom;"/></td>
            </tr>
            <tr style="background: #f7f7f7; text-align: center;">
                <td colspan="4">
                    <br/>
                    <span style="color: #999933; font-family: Helvetica, Arial, sans-serif; font-size: 36px;"><i>Olá, </i></span>
                    <br/>
                    <br/>
                </td>
            </tr>
             <tr>
                <td colspan="4"><img src="files/reset-senha/02.jpg"  style="vertical-align: bottom;"/></td>
            </tr>
             <tr>
                <td colspan="4" style="text-align: center; background: #f7f7f7;">
                    <span style="color: #2597ac; font-family: Helvetica, Arial, sans-serif; font-size: 16px;"><i>Senha: ' . $pass . '</i></span>
                </td>
            </tr>
            <tr>
                <td colspan="4"><img src="files/reset-senha/03.jpg"  style="vertical-align: bottom;"/></td>
            </tr>
             <tr>
...
// Limpa os destinatários e os anexos
	...
	public function createMobileUser($name = null, $email = null, $password = null, $birthday = null, $phone = null){
		$this->autoRender = false;
	...
	public function userMobileLogin($email = null, $password = null){
	$this->layout = "";
		...
		if(!empty($retorno)){
			...
			print_r(json_encode($retorno[0]['users']));
